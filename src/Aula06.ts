...
let num : Array<number>=[20,30,40] //outras forma de declarar um array do tipo numbwe

let num1 : Array<number|string>=[20,30,40,"leozi"] //esse array pode receber numeros ou strings
