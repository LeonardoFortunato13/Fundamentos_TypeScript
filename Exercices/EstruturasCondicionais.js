...
function question01(num1) {
    if (num1 % 2 == 0) {
        (console.log("o numero ".concat(num1, " \u00E9 par")));
    }
    else {
        console.log("o n\u00FAmero ".concat(num1, " \u00E9 impar"));
    }
}
function question02(ano) {
    if (ano % 4 == 0) {
        console.log("O ano ".concat(ano, " \u00E9 bissexto"));
    }
    else {
        console.log("O ano ".concat(ano, " n\u00E3o \u00E9 bissexto"));
    }
}
question02(1003);
